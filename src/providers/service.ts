...
export class Service {
  ...
  constructor(public http: Http, public user: UserData, platform: Platform) {
    // console.log("Service");

    //this.url = 'http://130.211.141.170/wp-content';
    //this.url = 'http://theindependentindian.com';
    //this.url = 'http://localhost/wp';
    if (platform.is("cordova")) {
      this.url = "https://tvcnews.tv";
    } else {
      this.url = "";
    }
  }
  ...
  getCategories() {
    ...
    return new Promise(resolve => {
      this.http
        .get(this.url + "/api/core/get_category_index/")
        .map(res => res.json())
        .subscribe(data => {
          console.log("Service::getCategories success", data);
          ...
          this.http
            .get(
              this.url +
                "/wp-admin/admin-ajax.php?action=mstoreapp-blog-settings"
            )
            .map(res => res.json())
            .subscribe(data => {
              this.settings = data;
  ...
  getVideoCategories() {
    console.log("Service::getVideoCategories");
    return new Promise(resolve => {
      this.http
        .get(
          this.url + "/wp-json/wp/v2/categories?parent=310&per_page=7&page=1"
        )
        .map(res => res.json())
        .subscribe(data => {
          console.log("Service::getVideoCategories success", data);
        ...
        group.sessions.forEach((session: any) => {
          ...
          if (session.speakerNames) {
            session.speakerNames.forEach((speakerName: any) => {
              let speaker = this.data.speakers.find(
  ...
  getTimeline(
    ...
    console.log("Service::getTimeline");
  ...
  getSpeakers() {
    console.log("Service::getSpeakers");
    return this.load().map((data: any) => {
  ...
  login(login: any) {
    ...
    return new Promise(resolve => {
      this.http
        .post(this.url + "/api/app/login/", params)
        .map(res => res.json())
        .subscribe(data => {
          this.http
            .get(
  ...
  register(signup: any) {
    ...
    return new Promise(resolve => {
      this.http
        .post(this.url + "/api/app/register", params)
        .map(res => res.json())
        .subscribe(data => {
          this.http
            .get(
  ...
  getPost(id: any) {
    ...
    return new Promise(resolve => {
      this.http
        .get(this.url + "/api/core/get_post/?" + "id=" + id)
        .map(res => res.json())
        .subscribe(data => {
          resolve(data);
        });
  ...
  getVideoCategoryPosts(id: any, page: any) {
    // console.log('getVideoCategoryPosts', id, page);
    return new Promise(resolve => {
      this.http
        .get(
          this.url +
            "/wp-json/wp/v2/mobilevideos?_embed&per_page=10&" +
            "categories=" +
            id +
            "&page=" +
            page
        ...
        .map(res => res.json())
        .subscribe(data => {
          // console.log('getVideoCategoryPosts success', data);
          resolve(data);
        });
    });
  }
  ...
  getVideoPost(id: any) {
    console.log("getVideoPost", id);
    return new Promise(resolve => {
      // https://tvcnews.tv/wp-json/wp/v2/mobilevideos/64476
      this.http
        .get(this.url + "/wp-json/wp/v2/mobilevideos/64476")
        .map(res => res.json())
        .subscribe(data => {
          console.log("getVideoPost success", data);
          resolve(data);
        });
    });
  }
  ...
  getTopPosts(page: any) {
    return new Promise(resolve => {
      this.http
        .get(
          this.url +
            "/api/core/get_tag_posts/?" +
            "page=" +
            page +
            "&slug=top-story&count=20"
        )
        .map(res => res.json())
        .subscribe(data => {
  ...
  getSlugPosts(page: any, slug: string) {
    return new Promise(resolve => {
      this.http
        .get(
          this.url +
  ...
  getFeaturedPosts() {
    return new Promise(resolve => {
      this.http
        .get(this.url + "/api/core/get_category_posts/?id=7222&page=1&count=5")
        .map(res => res.json())
        .subscribe(data => {
          resolve(data);
        });
  ...
  getRelatedPosts(id) {
    ...
    return new Promise(resolve => {
      this.http
        .get(this.url + "/api/core/get_category_posts/?" + "id=" + id)
        .map(res => res.json())
        .subscribe(data => {
  ...
  getPage(id) {
    ...
    return new Promise(resolve => {
      this.http
        .get(this.url + "/api/core/get_page/?" + "id=" + id)
        .map(res => res.json())
        .subscribe(data => {
          this.page = data;
          resolve(this.page);
  ...
  getSettings() {
    ...
    if (this.settings) {
      ...
      return new Promise(resolve => {
        this.http
          .get(
            this.url + "/wp-admin/admin-ajax.php?action=mstoreapp-blog-settings"
          )
          .map(res => res.json())
          .subscribe(data => {
            this.settings = data;
  ...
  submitComment(form, id) {
    ...
    return new Promise(resolve => {
      this.http
        .post(
          this.url + "/api/respond/submit_comment/?" + "post_id=" + id,
          params
        )
        .map(res => res.json())
        .subscribe(
  ...
  googleLogin(token, email, first_name, last_name) {
    ...
    return new Promise(resolve => {
      this.http
        .post(this.url + "/api/app/google_connect/", params)
        .map(res => res.json())
        .subscribe(data => {
          console.log(data);
          resolve(data);
  ...
  faceBookLogin(token) {
    ...
    return new Promise(resolve => {
      this.http
        .post(this.url + "/api/app/facebook_connect/", params)
        .map(res => res.json())
        .subscribe(data => {
          console.log(data);
          if (data.last_name) this.user.setUsername(data.last_name);
